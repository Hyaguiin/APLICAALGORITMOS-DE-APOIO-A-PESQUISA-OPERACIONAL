...
public class LinkedList<T> {   //linkdList generica p bubble up
	/* 
	 * Como n fizemos cm Array interno, e sim só lista generica, n da p ordenar c bubblesort padrao, ja q e p int
	 * */
	public Node<T> head;
